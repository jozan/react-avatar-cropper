...
class Cropper extends React.Component {
  ...
  render () {
    const ButtonClose = this.props.renderButtonSave();
    ...
    return (
      <div className="AvatarCropper-canvas">
        ...
        <div className="modal-footer">
          <ButtonClose onClick={this.props.onRequestHide} />
    ...
    return (
      <div className="AvatarCropper-base">
        <Cropper
          ...
          renderButtonClose={this.props.renderButtonClose}
          renderButtonSave={this.props.renderButtonSave}
        />
      </div>
    );
  }
...
AvatarCropper.propTypes = {
  ...
  renderButtonSave: React.PropTypes.func.isRequired,
  renderButtonClose: React.PropTypes.func.isRequired,
  onCrop: React.PropTypes.func.isRequired,
  width: numberableType,
  height: numberableType,
